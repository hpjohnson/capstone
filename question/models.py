...
DIFFICULTY = ((-1, "None Specified"), (0, "Easy"),
              (1, "Medium"), (2, "Hard"), (3, "Insane"))
STATUS = ((0, "Draft"), (1, "Pending Approval"),
          (2, "Approved"), (3, "Disapproved"))
...
class Question(models.Model):
    ...
    userID = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="question_post")
