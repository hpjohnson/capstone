...
The database for this website is rather simple, as it only contains 3 tables. Below is the entity relationship diagram for the database.

![ERD](docs/misc/erd.webp)
...
- Entity relationship diagram created using [Lucidchart](https://www.lucidchart.com/pages/landing).